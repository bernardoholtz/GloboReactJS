...
const url = 'https://api.github.com/users/globocom/repos?page=1&per_page=250';
const url2 = 'https://api.github.com/users/globocom/repos?page=2&per_page=250';
const url3 = 'https://api.github.com/users/globocom/repos?page=3&per_page=250';
...
class GitHub extends Component {
  ...
  function listarCommits(param,tipo){
		...
		var itens = [];
		 $.ajax({
				 type: "GET",
				 url : 'https://api.github.com/repos/globocom/' + param +'/commits?page=' + page +'&per_page=20',
				 crossDomain: true,
				 cache: false,
